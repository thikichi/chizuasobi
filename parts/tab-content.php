  ...
  <ul class="list-2">
    <li>
      <div class="list-2-box">
        <span class="_sub">2019.09.25</span>
        <span class="_main">
          ...
          <a href="#" class="hover-underline">ここに新着情報のタイトルがはいります。ここに新着情報のタイトルが … [続きを読む]</a>
          <span class="_small block">ここに新着情報のテキストの一部が表示されます…</span>
