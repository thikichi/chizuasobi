  ...
  <div class="box4-main">
    <div class="box4-main-inner">
      ...
      <div class="box4-list">
        ...
        <?php /* データ castle */ ?>
        <?php
        get_template_part( 'parts/items-all' );
        $get_term_arr = get_the_terms( $post->ID, 'landmark_cateogry' );
        foreach ($get_term_arr as $get_term) {
          get_template_part( 'parts/items', $get_term->slug );
        }
        ?>
